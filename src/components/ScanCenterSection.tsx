    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          <Badge variant="secondary" className="mb-4 text-xs tracking-wider uppercase px-4 py-1.5 rounded-full">Scan & Create</Badge>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Batch Creation */}
          <Card className="border-border/40 hover:shadow-elegant transition-all duration-300 rounded-2xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i}>
                      ...
                      <Input placeholder={f.placeholder} className="mt-1 text-sm rounded-xl" />
                    </div>
                  ))}
                  <div className="col-span-2 mt-3">
                    <Button className="w-full bg-primary text-primary-foreground hover:bg-primary-glow shadow-elegant hover:shadow-glow transition-all duration-300 rounded-xl" onClick={() => setCreating(true)}>
                ...
                <div className="text-center py-6 space-y-4 animate-fade-in">
                  ...
                  <div className="flex items-center justify-center gap-8 py-3">
                    <div className="text-center">
                      <div className="w-20 h-20 bg-muted rounded-xl flex items-center justify-center mb-1">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <Button key={i} variant="outline" className="h-20 flex-col gap-2 text-xs rounded-xl hover:border-primary hover:text-primary hover:shadow-soft transition-all duration-200" onClick={() => setScanned(true)}>
                        <btn.icon className="w-6 h-6" />
                        {btn.label}
                      </Button>
                    ))}
                  </div>
                  <div className="bg-muted/40 rounded-2xl p-8 text-center border border-border/30">
